...
class _MyHomePageState extends State<MyHomePage> {
  ...
  pickTextImageGallery() async {
    ...
    print('ini confidence $textConfidence');
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          setState(() {
            ...
            if (labelText == 'Steadiness' && textConfidence >= 50.0) {
              resultText =
            ...
            } else if (labelText == 'Steadiness' && textConfidence < 50.0) {
              resultText =
            ...
            if (labelText == 'Dominance' && textConfidence >= 50.0) {
              resultText =
            ...
            } else if (labelText == 'Dominance' && textConfidence < 50.0) {
              resultText =
            ...
            if (labelText == 'Influence' && textConfidence >= 50.0) {
              resultText =
            ...
            } else if (labelText == 'Influence' && textConfidence < 50.0) {
              resultText =
            ...
            if (labelText == 'Conscientiousness' && textConfidence >= 50.0) {
              resultText =
            ...
            children: [
              ...
              const Align(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(horizontal: 32),
                  child: Text(
                    'MoodScape adalah Aplikasi untuk mendeteksi mental health melalui tulisan tangan dan ekspresi wajah',
                    style: TextStyle(
                      fontSize: 16,
                    ),
                  ),
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: filepathText == null
                                ? const Image(
                                    image: AssetImage('assets/handwriting.jpg'),
                                    fit: BoxFit.cover,
                                  )
                                : Image.file(
                                    filepathText!,
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: filepathFace == null
                                ? const Image(
                                    image: AssetImage('assets/smiley.jpg'),
                                    fit: BoxFit.cover,
                                  )
                                : Image.file(
                                    filepathFace!,
              ...
              InkWell(
                ...
                onTap: () =>
                    launchUrlString('https://www.halodoc.com/kesehatan-mental'),
              ),
              const SizedBox(
                height: 128,
              )
